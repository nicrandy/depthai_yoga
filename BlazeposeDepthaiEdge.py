...
class BlazeposeDepthai:
    ...
    def build_manager_script(self):
        ...
        return code
########## new stuff
    def return_landmarks(landmarks,x):
        return landmarks,x
########## finish new stuff
...
############# new stuff
        current_landmarks = body.norm_landmarks
        # print("Body.norm_landmarks: ", body.norm_landmarks)
        # self.return_landmarks(current_landmarks)
############### finish new stuff
    ...
    def next_frame(self):
        ...
        if res["type"] != 0 and res["lm_score"] > self.lm_score_thresh:
            ...
            ##### added landmarks
            landmarks = self.lm_postprocess(body, res['lms'])
        ...
        return video_frame, body, landmarks 
